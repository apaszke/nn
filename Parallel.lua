...
function Parallel:updateOutput(input)
   ...
   for i=1,nModule do
      ...
      local currentOutput = self:callAndRethrow(self.modules[i], i, 'updateOutput', currentInput)
...
function Parallel:updateGradInput(input, gradOutput)
   ...
   for i=1,nModule do
      ...
      local currentGradInput = self:callAndRethrow(module, i, 'updateGradInput', currentInput, currentGradOutput)
